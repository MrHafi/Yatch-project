...
register_shutdown_function('yacht_sync_release_lock'); // Clear lock even if script stops unexpectedly.
// ---------------- Write sync log ----------------
...
function yacht_details_sync_batch() {
  ...
  $processed_count = 0;
    ...
    yacht_sync_log('Sync batch completed. Processed: ' . $processed_count . ', Next Offset: ' . ($offset + $limit));
}
